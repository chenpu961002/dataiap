...
sorted_by_amount_obama=sorted(amount_obama)
sorted_by_amount_mccain=sorted(amount_mccain)

sorted_by_amount_obama=filter(lambda y:y>=-18000 and y<=19000, sorted_by_amount_obama)
sorted_by_amount_mccain=filter(lambda y:y>=-22000 and y<=22000, sorted_by_amount_mccain)
